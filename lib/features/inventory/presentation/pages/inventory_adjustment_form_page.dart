...
class InventoryAdjustmentFormPage extends ConsumerStatefulWidget {
  const InventoryAdjustmentFormPage({super.key});

  static const String routeName = 'inventory-adjustment-new';
  static const String routePath = '/inventory/adjustments/new';

  @override
  ConsumerState<InventoryAdjustmentFormPage> createState() =>
      _InventoryAdjustmentFormPageState();
}

class _InventoryAdjustmentFormPageState
    extends ConsumerState<InventoryAdjustmentFormPage> {
  ...
  static const List<String> _types = ['POSITIVE', 'NEGATIVE', 'ADJUST'];
  ...
  Future<void> _submit() async {
    ...
    final result = await CreateInventoryAdjustmentUseCase(
