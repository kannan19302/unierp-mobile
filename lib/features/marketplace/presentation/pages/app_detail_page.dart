    ...
    return ListView(padding: const EdgeInsets.all(Spacing.x4), children: [
      _SectionCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          if (app.rating != null) Row(children: [Icon(Icons.star, color: Colors.amber, size: TypeScale.lg), Text('', style: Theme.of(context).textTheme.labelLarge)]),
        ]),
      ...
      _SectionCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _FieldRow('Reviews', ''), _FieldRow('Currency', app.currency),
