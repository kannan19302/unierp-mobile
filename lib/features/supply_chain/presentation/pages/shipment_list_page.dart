...
class ShipmentListPage extends ConsumerStatefulWidget {
  ...
  static const String routeName = 'shipments';
  static const String routePath = '/supply-chain/shipments';
  @override
...
class _ShipmentListPageState extends ConsumerState<ShipmentListPage> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(shipmentListControllerProvider);
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search shipment number',
  ...
  Widget _body(ShipmentListState state, ShipmentListController controller) {
    ...
    return PaginatedListView<Shipment>(
      ...
      emptyMessage: state.query.search?.isNotEmpty ?? false
          ...
          : 'Shipments created in UniERP will appear here.',
      itemBuilder: (_, Shipment shipment, __) => _ShipmentTile(
        shipment: shipment,
        onTap: () => context.pushNamed(
          'shipment-detail',
          pathParameters: <String, String>{'id': shipment.id},
        ),
      ),
    );
  }
